...
<div class="page-wrapper">
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="printableArea col-12" style="width:45%;">
            ...
            <div class="col-md-12">
                <div class="text-center">
                    ...
                    @else --}}
                    {{-- <a href="{{route('customer_order_details')}}" id="goto" class="btn btn-outline-danger" type="button">
                        <span><i class="fa fa-info"></i> To Pending Voucher Lists </span>

                    </a> --}}
                    <a href="{{route('customer_shop_order_details', $orders->id)}}" class="btn btn-info">Check Order Details</a>
                    {{-- @endif --}}
