        ...
        <div class="col-md-3">
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                    ...
                    <a class="dropdown-item" href="{{route('customerDelivery')}}">Delivery</a>
                                                    ...
                                                    <div class="m-l-10 align-self-center float-right">
                                                        <h4 class="m-b-1 font-lgiht" style="margin-top:30px;">Table Number -
                                                            ...
                                                            <div class="text-right">
                                                                {!! QrCode::size(100)->generate("http://192.168.1.104:8000/customer/Shop-Order/{$table->id}") !!}
                                                            </div>
                                                                                                                                                            </div>
                                                </div>
                                            </div>
                ...
                success:function(data){
                    ...
                    if ($.trim(data)){
                        ...
                        $.each(data, function(i, table) {
                            ...
                            var url = ' {{route("customer_shop_order_sale", ":table_id")}} ';
                                    ...
                                    <a href="${url}">
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <div class="text-right">
                                                    {!! QrCode::size(100)->generate("http://192.168.100.102:8000/Customer/Shop-Order/{$table->id}") !!}
                                                </div>
                                            </div>
                                        </div>
